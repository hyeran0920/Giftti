                    ...
                    <div class="card-body">
                        ...
                        <form action="giftUpdate.product" method="post">
                            ...
                            <tbody>
                           		 <tr>
                                    <th>등록번호</th>
                                    <td><input type="text" class="form-control" name="questionid" value="${question.questionid }" readonly > </td>
                                </tr>
                                <tr>
                                    <th>질문 내용</th>
                                ...
                                <th>카테고리</th>
                                    <td>
                                     <input class="form-control" name="qcategory" id="qcategory" value="${question.qcategory }" readonly>
