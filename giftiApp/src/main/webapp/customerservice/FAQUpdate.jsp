                    ...
                    <div class="card-body">
                        ...
                        <form action="FAQUpdate.customerservice" method="post" onsubmit="return checkFAQInsert()">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>질문 내용</th>
                                    <td><input type="text"  class="form-control" name="faquestion" id="faquestion" value="${faq.faquestion }"> </td>
                                </tr>
                                ...
                                <th>카테고리</th>
  								...
  								<c:if test="${faq.qcategory ne '결제관련'}">
  									<option value="결제관련">결제관련</option>
  								</c:if>
  								<c:if test="${faq.qcategory ne '서비스이용'}">
  									<option value="서비스이용">서비스이용</option>
  								</c:if>
  								<c:if test="${faq.qcategory ne '서비스안내'}">
