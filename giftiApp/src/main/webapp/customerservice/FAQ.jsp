			...
			<main>
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					<div class="container-fluid">
						<ul class="navbar-nav">
							<li class="nav-item category"><a class="nav-link" href="">전체</a>
							</li>
							<li class="nav-item category"><a class="nav-link"
								href="findCategoryAll.customerservice?qcategory=서비스안내"> 서비스
									안내 </a></li>
							<li class="nav-item category"><a class="nav-link"
								href="findCategoryAll.customerservice?qcategory=상품관련"> 상품 관련
							</a></li>
							<li class="nav-item category"><a class="nav-link"
								href="findCategoryAll.customerservice?qcategory=서비스이용"> 서비스
									이용 </a></li>
							<li class="nav-item category"><a class="nav-link"
								href="findCategoryAll.customerservice?qcategory=결제관련"> 결제 관련
							</a></li>

						</ul>
						<button type="submit" class="btn btn-secondary btn-sm"
								id="btn_update"
								onclick="location.href='FAQInsertView.customerservice'"><i class="fa-solid fa-plus"></i> FAQ 등록</button>
					...
					<div class="accordion-item">
						<c:forEach var="question" items="${questions}">
							...
							<div id="collapse${question.questionId}"
								...
								aria-labelledby="heading${question.questionId}"
								data-bs-parent="#accordionExample">
								<div class="accordion-body">${question.answer}
