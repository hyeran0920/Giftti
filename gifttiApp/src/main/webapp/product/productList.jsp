                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                                <tr>
                                    <td>${item_id}</td>
                                    <td><a href="productSaleList.html">${item_name}</a></td>
                                    <td>${price}</td>
                                    <td>${brand}</td>
                                    <td>${category}</td>
                                    <td>
                                    ...
                                    <td>등록수${item_id.count}
                                        <!-- 판매테이블의 item_id를 count해서 누적갯수 구하기 -->
                                        <!-- data count -->
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td><a href="productSaleList.html">고추 바사삭</a></td>
                                    <td>24,500</td>
                                    <td>굽네 치킨</td>
                                    <td>치킨</td>
                                    <td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td><a href="productSaleList.html">갈비천왕</a></td>
                                    <td>20,500</td>
                                    <td>굽네 치킨</td>
                                    <td>치킨</td>
                                    <td>
